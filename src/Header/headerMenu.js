...
export default function HeaderMenu() {
  return (
    <div className="headMenu d-flex flex-row justify-content-between">
      <div className="headMenuDropdowns d-flex flex-row">
        <div>
          <DropdownButton
      ...
      <p className="d-flex align-items-center">30 days free return</p>
    </div>
  );
}
